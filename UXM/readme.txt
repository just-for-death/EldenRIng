...
--| This is a quick and hacky modification of UXM 2.4
--| Elden Ring support by Meowmartitus
--| Original UXM by TKGP

 -Adds support for Elden Ring.
 -Unpacks all files except some weird duplicate shader files that don't seem to be used.
 -Unpacked game will take 101 GB total, with the archives needing to remain there.
 -Important: Do not run the game with Easy Anti Cheat (EAC) if you patch the EXE to load loose files. 
             Info on how to run without EAC is available in the modding server 
             (YES THIS MEANS FILE MODS COMPLETELY DO NOT WORK ONLINE)
